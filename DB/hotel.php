...
<div class="well well-lg wrap-msg" style="width: 1300px;">
	<div class ="row">
		...
		if(!isset($_GET["sort"])) {
		?>
		<div class="col-sm-2"><a href ="hotel.php" class="btn btn-success" style ="width: 80%; margin-top: 18px;"><span class="fa fa-thumbs-up"></span> Sorted by Likes</a></div>
		...
		?>
		<div class="col-sm-2"><a href ="hotel.php" class="btn btn-primary" style ="width: 80%; margin-top: 18px;"><span class="fa fa-thumbs-up"></span> Sort by Likes</a></div>
		...
		if(!isset($_GET["sort"])) {
		?>
		<div class="col-sm-2"><a href ="hotel.php?sort=3" class="btn btn-primary" style ="width: 80%; margin-top: 18px;"><span class="fa fa-dollar"></span> Sort by Prices</a></div>
		<?php
		} else if ($_GET["sort"] == 2) {
		?>
		<div class="col-sm-2"><a href ="hotel.php?sort=3" class="btn btn-primary" style ="width: 80%; margin-top: 18px;"><span class="fa fa-dollar"></span> Sort by Prices</a></div></a>
		<?php
		} else {
		?>
		<div class="col-sm-2"><a href ="hotel.php?sort=3" class="btn btn-success" style ="width: 80%; margin-top: 18px;"><span class="fa fa-dollar"></span> Sorted by Prices</a></div>
		<?php
		}
		?>
	</div>
...
<?php 
	if(!isset($_GET["sort"])) {
	$sql = "call get_hotels_sorted_by_likes()";
	$stmt = $mysqli->prepare($sql);
	if($stmt)
	{
		$stmt->execute();
