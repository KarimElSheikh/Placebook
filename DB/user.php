...
<div class="row well well-lg">
	<div class="row">
		...
		<?php if($loggedIn) { ?>
		<div class="col-sm-2"><p></p></div>
		<div class="col-sm-2"><a href="register_success.php" class="btn btn-default" style ="width: 80%; margin-top: 18px;"><span class="fa fa-gears"></span> Settings</a></div>
		...
		<div class="col-sm-2"><a  href="message.php?email=<?php echo $targetEmail?> "class="btn btn-default" style ="width: 80%; margin-top: 18px;"><span class="fa fa-comments-o"></span> Message</a></div>
...
<div class="row well well-lg">
	...
	<?php
	$sql = "select p.name ,p.pid from member_liked ml inner join place p on p.pid =ml.pid where ml.member_email =?";
...
<div class="row well well-lg">
	<div class="col-sm-12 subHeaderLabel">Visited</div>
		<?php
	$stmt->close();
	$sql = "select p.name ,p.pid from visited V inner join place p on p.pid =v.pid where v.member_email =?";
	$stmt = $mysqli->prepare($sql);
	if($stmt)
	{
