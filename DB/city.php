...
<div class="well well-lg wrap-msg">
	<div class ="row">
		...
		<div class="col-sm-2"><a href ="city.php" class="btn btn-primary" style ="width: 80%; margin-top: 18px;"><span class="fa fa-thumbs-up"></span> Likes</a></div>
...
<?php 
	if(!isset($_GET["sort"])) {
	$sql = "call get_city_with_most_likes()";
	$stmt = $mysqli->prepare($sql);
	if($stmt)
	{
		$stmt->execute();
