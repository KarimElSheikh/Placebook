...
<div class="well well-lg wrap-msg-sm">
...
<div class="well well-lg wrap-msg-sm fixed-bottom" id="messageGroup">
	<form action="send_message.php"role="form" name="message_form" method = "POST">
		<div class="row">
			<div class="col-sm-12">
