...
<div class="row well well-lg">
	<div class="row">
		<div class="col-md-6 subHeaderLabel"><p><?php echo $fname." ".$lname; ?></p></div>
		...
		<div class="col-md-2"><a href="friendAction.php<?php action('add', $b, $o) ?>" class="btn btn-default" style ="width: 80%; margin-top: 18px;"><span class="fa fa-plus"></span> Add Friend</a></div>
		...
		if ($outgoing == 1) {
		?>
		<div class="col-md-2"><a class="btn btn-primary" style ="width: 80%; margin-top: 18px;"><span class="fa fa-spinner"></span> Sent</a></div>
		<div class="col-md-2"><a class="btn btn-default" style ="width: 80%; margin-top: 18px;"><span class="fa fa-comments-o"></span> Message</a></div>
		<?php } else { ?>
		<div class="col-md-2"><a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style ="width: 80%; margin-top: 18px;"><span class="fa fa-spinner"></span> Respond</span></a>
	...
	<br>
	<div class="row">
		<div class="col-md-3"><?php echo $targetEmail; ?></div>
		<div class="col-md-3"><?php echo $nat; ?></div>
		<div class="col-md-3"><?php echo $addr; ?></div>
		<div class="col-md-3">
